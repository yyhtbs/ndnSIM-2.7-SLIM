...
#ifndef NFD_DAEMON_FW_CODEL_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_CODEL_ROUTE_STRATEGY_HPP
 ...
 */
class CodelRouteStrategy : public Strategy
                         , public ProcessNackTraits<CodelRouteStrategy>
{
public:
  explicit
  CodelRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<CodelRouteStrategy>;
};
