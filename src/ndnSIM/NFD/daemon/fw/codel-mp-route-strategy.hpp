...
#ifndef NFD_DAEMON_FW_CODEL_MP_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_CODEL_MP_ROUTE_STRATEGY_HPP
...
/** \brief CODEL Route strategy version 4
 *
 ...
 */
class CodelMpRouteStrategy : public Strategy
                         , public ProcessNackTraits<CodelMpRouteStrategy>
{
public:
  explicit
  CodelMpRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<CodelMpRouteStrategy>;
...
#endif // NFD_DAEMON_FW_CODEL_ROUTE_STRATEGY2_HPP
