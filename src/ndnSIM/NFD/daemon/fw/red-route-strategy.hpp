...
#ifndef NFD_DAEMON_FW_RED_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_RED_ROUTE_STRATEGY_HPP
 ...
 */
class RedRouteStrategy : public Strategy
                         , public ProcessNackTraits<RedRouteStrategy>
{
public:
  explicit
  RedRouteStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<RedRouteStrategy>;
};

} // namespace fw
} // namespace nfd

#endif // NFD_DAEMON_FW_RED_ROUTE_STRATEGY2_HPP
