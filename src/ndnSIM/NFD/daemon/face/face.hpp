...
public:
  uint64_t m_baseHopRtt = UINT64_MAX;
  uint64_t m_queueDelay = 0;
  time::steady_clock::TimePoint m_firstAboveTime;
  double_t m_reactTimeWindow = 100e6;
  double_t m_totalLoss = 0;
  bool m_isChecking = 0;
