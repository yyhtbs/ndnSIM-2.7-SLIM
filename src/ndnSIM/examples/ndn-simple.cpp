...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::InstallAll("/prefix", "/localhost/nfd/strategy/rfa-route/");
  ...
  ndn::FibHelper::AddRoute(nodes.Get(0), "/prefix", nodes.Get(1), 1); // link to n1
  ndn::FibHelper::AddRoute(nodes.Get(1), "/prefix", nodes.Get(2), 1); // link to n1
