...
public: // getter/setter
  ...
  /** @brief set NextHopRtt
   *  @param type a measure of local RTT measure
   */
  MetaInfo&
  setNextHopRtt(uint32_t thisHopRtt);
