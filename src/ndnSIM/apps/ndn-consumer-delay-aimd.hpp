...
#ifndef NDN_CONSUMER_DELAY_AIMD_H
#define NDN_CONSUMER_DELAY_AIMD_H
...
class ConsumerDelayAimd : public Consumer {
public:
  static TypeId
  GetTypeId();
...
protected:
  ...
  protected:
    std::list<std::pair<uint64_t, uint64_t> > m_rttSamples;
